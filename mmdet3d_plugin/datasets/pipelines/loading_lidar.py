...
class LoadPointsFromVelo(object):
    def __init__(self,
        data_root=None,
        dataset='kitti',
        load_seg=False
    ...
    def __call__(self, results):
        ...
        x, y, d = projected_points[..., 0], projected_points[..., 1], projected_points[..., 2]
        valid_mask = (x >= 0) & (y >= 0) & (x < img_w) & (y < img_h) & (d > 0)

        results['points'] = projected_points[valid_mask]
